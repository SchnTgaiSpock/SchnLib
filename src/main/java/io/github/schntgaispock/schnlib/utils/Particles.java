...
public class Particles {
    ...
    public static void drawCircle(Location location, Particle particle, int radius, int points, Vector normal, ParticleOptions<?> options) {
        ...
        for (double i = 0; i < points; i++) {
            ...
            draw(location.clone().add(
                ...
                radius * (v1.getZ() * cosValue + v2.getZ() * sinValue)
            ), particle, options);
        }
    }
    
    public static void drawCircle(Location location, Particle particle, int radius, Vector normal, ParticleOptions<?> options) {
    ...
    public static void drawCircle(Location location, Particle particle, int radius, int points, ParticleOptions<?> options) {
        for (double i = 0; i < points; i++) {
            final double fraction = i / points;
            draw(location.clone().add(radius * Math.cos(2*Math.PI*fraction), 0, radius * Math.sin(2*Math.PI*fraction)), particle, options);
        }
    }
    ...
    // public static void drawRect(Location corner1, Location corner2, Particle particle, ParticleOptions<?> options) {
